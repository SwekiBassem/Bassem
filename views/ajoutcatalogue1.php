...
<head>
	...
	<form method="POST" action="ajoutcatalogue.php">
    <div class="panel-body">
        <form role="form">
		<div class="form-group has-warning">
                        <label class="control-label" for="warning">Nom du Catalogue</label>
                        <input type="text" class="form-control" id="warning" name="nom"/>
                    </div>
                    <div class="form-group has-warning">
                        <label class="control-label" for="warning">Catalogue Cover</label>
                        <input type="file"  id="warning" name="fichier"/>
					</div>
					<div class="form-group has-warning">
                        <label class="control-label" for="warning">Description</label>
                        <input type="text"  id="warning" name="descrip"/>
                    </div>
</form>
