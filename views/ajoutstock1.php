...
$listecatalogues=$catalogue1C->affichercatalogues();

//var_dump($listecatalogues->fetchAll());
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
	...
	<form method="POST" action="ajoutstock.php">
    <div class="panel-body">
        <form role="form">
                    <div class="form-group has-warning">
                        <label class="control-label" for="warning">Nom</label>
                        <input type="text" class="form-control" id="warning" name="nom"/>
                    </div>
                    <div class="form-group has-error">
                        <label class="control-label" for="error">Prix</label>
                        <input type="text" class="form-control" id="error" name="prix"/>
                    </div>
					<div class="form-group has-success">
                        <label class="control-label" for="success">Quantite</label>
                        <input type="number" class="form-control" id="success" name="quantite"/>
                    </div>
					 <div class="form-group has-warning">
                        <label class="control-label" for="warning">Categorie</label>
                        <select class="form-control" name="categorie" type="text">
                            <option>Lavabo</option>
                            <option>Faience</option>
                            <option>Bainoire</option>
                            </select>
                    </div>
                    <div class="form-group has-warning">
                        <label class="control-label" for="warning">Selectionner les photos</label>
                        <input type="file"  id="warning" name="fichier"/>
                    </div>
</form>
