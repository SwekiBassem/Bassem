...
if (isset($_POST['modifier'])){
	$stock=new stock($_POST['nom'],$_POST['prix'],$_POST['quantite'],$_POST['categorie'],$_POST['fichier']);
...
<head>
			...
			<div class="main-wrapper" >
				...
				<nav class="navbar navbar-expand-lg main-navbar">
					<a class="header-brand" href="index-2.html">
						<img src="assets/img/brand/TESTGALAXY.png" class="header-brand-img" alt="Splite-Admin  logo">
					</a>
					...
					<ul class="navbar-nav navbar-right">
							...
							<div class="dropdown-menu dropdown-list dropdown-menu-right">
								...
								<div class="dropdown-list-content">
									<a href="#" class="dropdown-item dropdown-item-unread">
										<img alt="image" src="assets/img/avatar/bassem.jpg" class="rounded-circle dropdown-item-img">
						...
						<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg d-flex">
								<span class="mr-3 mt-2 d-none d-lg-block ">
									<span class="text-white">Hello,<span class="ml-1"> Bassem Sweki</span></span>
								</span>
							<span><img src="assets/img/avatar/bassem.jpg" alt="profile-user" class="rounded-circle w-32 mr-2"></span>
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								<div class=" dropdown-header noti-title text-center border-bottom pb-3">
									<h5 class="text-capitalize text-dark mb-1">Bassem Sweki</h5>
				...
				<aside class="app-sidebar">
					<div class="app-sidebar__user">
						<div class="dropdown user-pro-body text-center">
							<div class="nav-link pl-1 pr-1 leading-none ">
								<img src="assets/img/avatar/bassem.jpg" alt="user-img" class="avatar-xl rounded-circle mb-1">
								<span class="pulse bg-success" aria-hidden="true"></span>
							</div>
							<div class="user-info">
								<h6 class=" mb-1 text-dark">Bassem Sweki</h6>
					...
					<ul class="side-menu">
						<li class="slide">
							<a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon fa fa-laptop"></i><span class="side-menu__label">Gestion Produit</span></a>
							<ul class="slide-menu">
								<li><a class="slide-item"  href="index-2.php"><span>Gestion Produit </span></a></li>
								<li><a class="slide-item" href="index2.php"><span>Gestion Catalogue</span></a></li>
	...
	<form method="POST" action="modifierstock.php">
    <div class="panel-body">
        ...
        <div class="form-group has-success">
                    ...
                    <div class="form-group has-error">
                        <label class="control-label" for="error">saisir le prix</label>
                        <input type="text" class="form-control" id="error" name="prix" value="<?PHP echo $prix ?>"/>
					</div>
					
                    <div class="form-group has-success">
                        <label class="control-label" for="success">Saisir la Quantite</label>
                        <input type="number" class="form-control" id="success" name="quantite" value="<?PHP echo $quantite ?>"/>
                    </div>
					<div class="form-group has-success">
                        <label class="control-label" for="success">Saisir le Categorie</label>
                        <input type="text" class="form-control" id="success" name="categorie" value="<?PHP echo $categorie ?>"/>
                    </div>
                    <div class="form-group has-warning">
                        <label class="control-label" for="warning">Selectionner un fichier</label>
                        <input type="file"  id="warning" name="fichier" value="<?PHP echo $fichier ?>"/>
                    </div>
                </form>
