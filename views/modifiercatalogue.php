...
if (isset($_POST['modifier'])){
	$catalogue=new catalogue($_POST['nom'],$_POST['fichier'],$_POST['descrip']);
	$catalogueC->modifiercatalogue($catalogue,$_POST['id_ini']);
...
<head>
	...
	<form method="POST" action="modifiercatalogue.php">
    <div class="panel-body">
        ...
        <div class="form-group has-warning">
					...
					<div class="form-group has-warning">
                        <label class="control-label" for="warning">Description</label>
                        <input type="text"  id="warning" name="descrip" value="<?PHP echo $description ?>"/>
                    </div>
                </form>
