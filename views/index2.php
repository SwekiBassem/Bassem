				...
				<nav class="navbar navbar-expand-lg main-navbar">
					...
					<form class="form-inline mr-auto">
						...
						<div class="search-element mr-3">
							<input class="form-control" id="myInput" onkeyup="myFunction()" type="text" placeholder="Search" aria-label="Search">
				...
				<aside class="app-sidebar">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a href="../views/backend/livreur.php" class="slide-item"> Gestion livreur</a></li>
								<li><a href="../views/backend/livraison.php" class="slide-item"> Gestion livraison</a></li>
							</ul>
						</li>
						...
						<div class="row">
							<div class="col-12 col-sm-12">
								<div class="card">
									...
									<a href="ajoutcatalogue1.php">
										<button class="btn btn-info" style="margin-left:85%;margin-top:30px;">Ajouter</button>
									</a>
									<div class="card-body">
											...
											<table class="table table-bordered text-nowrap mb-0" id="myTable">
												<thead>
													<tr>
														...
														<th>Catalogue ID</th>
														<th>Catalogue noun</th>
														<th>File</th>
														<th>Descriptin</th>
													</tr>
												</thead>
<?PHP
foreach($listecatalogues as $row){
	?>
        <tbody>
            ...
            <tr>
				...
				<td><img src="../img/<?PHP echo $row['fichier']; ?>" width="40px"> </img></td>
   ...
   <input type="submit" class="btn btn-info" value="Delete">
	...
	<td><a href="modifiercatalogue.php?id=<?PHP echo $row['id']; ?>">
	<button class="btn btn-warning">Modifier</button></a></td>
            </tr>
