<?PHP
include "C:/wamp64/www/tajriba/entites/livreur.php";
include "C:/wamp64/www/tajriba/core/livreurC.php";

if (isset($_POST['cin']) and isset($_POST['nom']) and isset($_POST['prenom']) and isset($_POST['email']) and isset($_POST['secteur'])and isset($_POST['etat'])){
$livreur1=new livreur($_POST['cin'],$_POST['nom'],$_POST['prenom'],$_POST['email'],$_POST['secteur'],$_POST['etat']);
//Partie2
/*
var_dump($livreur1);
}
*/
//Partie3
$lcin=strlen($_POST['cin']);
$lnom=strlen($_POST['nom']);
$lprenom=strlen($_POST['prenom']);
if($lnom>0 && $lprenom>0 && $lcin==8) {
    ...
    <div class="panel-body">
        <form role="form">
                    <div class="form-group has-success">
                        <label class="control-label" for="success">Cin</label>
                        <input type="number" class="form-control" id="success" name="cin" placeholder="8 chiffres"/>
                    </div>
                    ...
                    <div class="form-group has-error">
                        <label class="control-label" for="error">Prenom</label>
                        <input type="text" class="form-control" id="error" name="prenom"/>
                    </div>
					<div class="form-group has-error">
                        <label class="control-label" for="error">E-mail</label>
                        <input type="text" class="form-control" id="error" name="email"/>
                    </div>
                </form>
