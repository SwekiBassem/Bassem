...
if (isset($_POST['modifier'])){
	$livreur=new livreur($_POST['cin'],$_POST['nom'],$_POST['prenom'],$_POST['email'],$_POST['secteur'],$_POST['etat']);
    ...
    <div class="panel-body">
        <form role="form">
					...
					<div class="form-group has-error">
                        ...
                        <input type="text" class="form-control" id="error" name="email" value="<?PHP echo $email ?>"/>
					</div>
                    <div class="form-group has-success">
                        <label class="control-label" for="success">Secteur</label>
