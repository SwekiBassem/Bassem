...
if (isset($_POST['modifier'])){
	$livraison=new livraison($_POST['idclient'],$_POST['nom'],$_POST['adresse'],$_POST['numtel'],$_POST['numcommande'],$_POST['liv'],$_POST['date_livraison']);
...
$num=$_POST['numtel'];
	...
	$username = "aymen.negra@esprit.tn";
	$hash = "4aaaa840b9f8e9b74a40c0db46ea38bb2e40550016e32f5f45082e133a78ce3c";
