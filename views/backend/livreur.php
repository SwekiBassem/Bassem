		...
		<div id="app" class="page">
			<div class="main-wrapper" >
				...
				<aside class="app-sidebar">
					...
					<ul class="side-menu">
						<li class="slide">
							<a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon fa fa-laptop"></i><span class="side-menu__label">gerer livraison</span></a>
							<ul class="slide-menu">
					...
					<li class="slide">
							...
							<ul class="slide-menu">
								<li><a href="../index-2.php" class="slide-item"> Gestion Produit</a></li>
								<li><a href="../index2.php" class="slide-item"> Gestion catalogue</a></li>
							</ul>
						</li>
				</aside>
				<!--aside closed-->
...
<form action="trier.php" methode="POST">
<input class="btn btn-info" type="submit" style="margin-left:85%;margin-top:30px;" name="tri" value="trier">
</form>
										</div>
									</div>
								</div>
