<?PHP
        ...
        $stock1C=new stockC();
        $listestocks=$stock1C->affichersingle($_GET['id']);
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light ftco-navbar-light-2" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Galaxy</a>
    ...
    <!-- END nav -->
		...
		<div class="hero-wrap hero-bread" style="background-image: url('images/manchester1.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-0 bread">Product Catalogue</h1>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="../img" class="image-popup"><img src="../img/<?PHP echo $row['fichier']; ?>" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
            <h3><?PHP echo $row['nom'] ?></h3>
            <h4 class="price" style="color:#000000;"> <?PHP echo $row['prix'] ?><span> DT</span></h4>
            <h5>Catégorie : <?PHP echo $row['categorie'] ?></h5>
            <div id="average">
    <?=$avg_rating?>
  </div>
  ...
  <?php } ?>
	<p><a href="shop.php" class="btn btn-primary py-3 px-5">Add to Cart</a></p>
    			</div>
    		</div>
    	</div>
    </section>
