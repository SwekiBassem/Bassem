<?PHP
        ...
        $stock1C=new stockC();
        $listestocks=$stock1C->afficherdecroissant();
...
<html lang="en">
  ...
  <select onchange="la(this.value)">
    <option value="shop_decroissant.php" selected>Prix Decroissant</option>
    	...
    	<div class="container-fluid">
    		<div class="row">
				<?PHP
    				...
    				<div class="product">
    					<a href="singlepage.php?id=<?PHP echo $row['id']; ?>" class="img-prod"><img class="img-fluid" src="../img/<?PHP echo $row['fichier']; ?>" alt="Colorlib Template">
    					</a>
