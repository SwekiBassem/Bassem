...
<html lang="en">
  ...
  <body>
    ...
    <!-- END nav -->
		...
		<div class="hero-wrap js-fullheight" style="background-image: url('images/manchester1.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
        	<h3 class="v">Galaxy Design - Time to get Galaxy</h3>
        	<h3 class="vr">Since - 1985</h3>
          <div class="col-md-11 ftco-animate text-center">
            <h1>Galaxy Design</h1>
            <h2><span>Live in Galaxy</span></h2>
          </div>
          <div class="mouse">
    		...
    		<div class="row">
    			...
    			<div class="col-md-12">
    				...
    				<div class="product-slider owl-carousel ftco-animate">
    					<div class="item">
		    				<div class="product">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="../img/<?PHP echo $row['fichier']; ?>" alt="Colorlib Template">
		    					...
		    					<div class="text pt-3 px-3">
		    						...
		    						<div class="d-flex">
		    							<div class="pricing">
			    							<p class="price"></span><?PHP echo $row['prix'] ?><span>DT</span></p>
			    						</div>
			    						<div class="rating">
			    							<p class="text-right">
